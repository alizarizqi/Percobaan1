...
public class UIPenjualan extends javax.swing.JFrame {
    ...
    //untuk mengisi parameter dari model hotel dimana yg akan diSet di combobox
    private void fillComboBarang(){
        ModelHotel hotel0 = new ModelHotel("", "", 0);
        ModelHotel hotel1 = new ModelHotel("Regular Room", "hari", 700000);
        ModelHotel hotel2 = new ModelHotel("Super Room", "hari", 1500000);
        ModelHotel hotel3 = new ModelHotel("Deluxe Room", "hari", 3600000);
        
        cboBarang.addItem(hotel0);
        cboBarang.addItem(hotel1);
        cboBarang.addItem(hotel2);
        cboBarang.addItem(hotel3);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORMASI HOTEL");
    ...
    private void cboBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboBarangActionPerformed
        barang = (ModelHotel) cboBarang.getSelectedItem();
